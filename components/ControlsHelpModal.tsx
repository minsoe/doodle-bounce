        ...
        <div className="space-y-2.5 mb-5 relative z-10">
          ...
          <div className="bg-white/85 p-3 rounded-2xl border-2 border-slate-300 flex items-center justify-between shadow-sm">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-emerald-100 border border-emerald-400 text-emerald-700 flex items-center justify-center font-bold">
                <ArrowUp className="w-5 h-5 stroke-[2.5]" />
              </div>
              <div>
                <span className="font-black text-sm text-slate-900">JUMP</span>
                <p className="text-[11px] text-slate-600">Bounce higher or trigger mid-air boost</p>
              </div>
            </div>
